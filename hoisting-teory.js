...
// 1. Rezerwacja pamięci (Hoisting)
// Kiedy silnik JavaScript wchodzi w dany blok kodu {...}, natychmiast "skanuje" go w poszukiwaniu deklaracji let i const. Rezerwuje on nazwy tych zmiennych w pamięci na początku bloku, co technicznie jest formą hoistingu.
// 2. Temporal Dead Zone (Czasowa Martwa Strefa)
// Mimo że nazwa zmiennej jest już znana silnikowi, pozostaje ona w stanie "uninitialized" (niezainicjalizowana).
// Okres od początku bloku do momentu, w którym kod faktycznie dotrze do linii z deklaracją let lub const, nazywamy Temporal Dead Zone (TDZ).
// Jeśli spróbujesz użyć zmiennej, gdy znajduje się ona w TDZ, otrzymasz błąd: ReferenceError: Cannot access 'x' before initialization
