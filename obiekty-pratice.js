...
console.log("Dane kardiomonitora: model - " + kardiomonitor[parametrDoSprawdzenia1] + ", zakres ciśnienia: " + kardiomonitor[parametrDoSprawdzenia2] + ", zakres tętna: " + kardiomonitor[parametrDoSprawdzenia3] + ", stan baterii: " + kardiomonitor[parametrDoSprawdzenia4] + ".");
...
const newPatient = [
    {namePatient: "John", patientId: 12 , disease: "Heart Attack", chanceToRecover: false},
    {namePatient: "Gregory", patientId: 13 , disease: "FLU", chanceToRecover: false},
    {namePatient: "Anna", patientId: 14 , disease: "CANCER", chanceToRecover: true},
    {namePatient: "Henry", patientId: 15 , disease: "COVID", chanceToRecover: false}


]

    const   chanceToRecoverStatus = newPatient[0].chanceToRecover ? "przeżyje" : "nie przeżyje"
    let newParametrToCheck = "namePatient"
    let newParametrToCheck1 = "chanceToRecover"
    console.log(`Pacjent: ${newPatient[0][newParametrToCheck]} ${chanceToRecoverStatus}`);


newPatient.push({namePatient: "Donald", patientId: 44 , disease: "Hernia", chanceToRecover: false});
newPatient.unshift({namePatient: "Barrac", patientId: 1 , disease: "severed penis", chanceToRecover: false})
    const newPatients =[...newPatient,{namePatient: "Emmy", patientId: 69 , disease: "dildo in Ass", chanceToRecover: false}]
